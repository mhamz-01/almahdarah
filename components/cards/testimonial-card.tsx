...
export function TestimonialCard({ quote, name, role, accent, featured }: Testimonial) {
    ...
    return (
      ...
      >
        <div className="min-w-[260px] flex-1">
          ...
          <p className="mt-3.5 font-serif text-[clamp(20px,2.2vw,28px)] leading-[1.4] text-white italic">
            &ldquo;{quote}&rdquo;
          </p>
          <div className="mt-[22px] flex items-center gap-3.5">
            ...
            <div>
              ...
              <div className="text-[13px] text-white/78">{role}</div>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="rounded-[20px] border border-white/14 bg-white/[0.07] p-[26px]">
      <StarRating className="text-sm" />
      <p className="mt-3 text-[14.5px] leading-[1.6] text-white/92">&ldquo;{quote}&rdquo;</p>
      <div className="mt-5 flex items-center gap-3 border-t border-white/12 pt-[18px]">
        ...
        <div>
          ...
          <div className="text-[12.5px] text-white/70">{role}</div>
        </div>
      </div>
    </div>
  );
