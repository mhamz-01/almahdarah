  ...
  return (
    <section id="top" className="relative">
      ...
      <div className="relative mx-auto grid max-w-[1240px] grid-cols-1 items-center gap-10 px-7 py-16 sm:py-20 lg:grid-cols-2 lg:gap-16 lg:py-[92px]">
        ...
        <div className="relative">
          ...
          <div className="absolute -right-3 -bottom-[18px] flex items-center gap-2.5 rounded-[14px] border border-border bg-surface px-4 py-3 shadow-[var(--shadow-md)]">
            <span className="h-2.5 w-2.5 rounded-full bg-green shadow-[0_0_0_4px_rgba(62,158,84,0.24)]" />
      ...
      <div className="border-y border-border bg-surface">
        <div className="mx-auto flex max-w-[1240px] flex-wrap items-center justify-center gap-x-[34px] gap-y-3 px-7 py-[17px] text-[13px] font-semibold tracking-[0.02em] text-muted">
          {subjects.map((subject, i) => (
            <span key={subject} className="contents">
